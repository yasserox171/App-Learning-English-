...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'daily_cap_reached': 'Daily limit reached — come back tomorrow! 🌙',
      'redeem': 'Redeem',
      'redeem_success': 'Premium activated! Enjoy 🎉',
      'premium_active_until': 'Premium active until',
      'premium_days_3': '3 days premium',
      'premium_days_7': '1 week premium',
      'premium_days_30': '1 month premium',
      'coins_short': 'coins',
      'subscribe_now': 'Subscribe now',
      'other_payment_methods': 'Other payment methods',
      'whatsapp_payment': 'WhatsApp / bank transfer (~24h to activate)',
      'premium_title': 'Premium',
      'monthly_plan': 'Monthly — \$6',
      'annual_plan': 'Annual — \$60 (2 months free)',
      'play_billing_unavailable':
          'Google Play Billing is not available on this build yet.',
      'ai_tutor': 'AI Tutor',
      'talk_with_tutor': 'Talk with the AI Tutor',
      'tutor_intro':
          'Have a short spoken conversation about this lesson. Try to use the target words!',
      'tutor_tap_to_speak': 'Tap to speak',
      ...
      'choose_level_manually': 'Choose a level manually',
      'coins_plus': 'coins',
      ...
      'preferred_time': 'Reminder time',
      'content_alert': 'New content alerts',
      'weak_area_alert': 'Weak-area tips',
      'achievement_alert': 'Achievement unlocks',
      'share_achievement': 'Share your achievement',
      'share_lesson_text':
          'I finished the "{lesson}" lesson on Focus Languages and scored {percent}% 🎉',
      'words_learned': 'Words',
      ...
      'skills_tree': 'Skills',
      'vocab_heatmap': 'Vocabulary by topic',
      'no_data_yet': 'Start learning to see your stats here!',
    ...
    'ar': {
      ...
      'daily_cap_reached': 'وصلت للحد اليومي — عد غداً! 🌙',
      'redeem': 'استبدال',
      'redeem_success': 'تم تفعيل الاشتراك المميز! استمتع 🎉',
      'premium_active_until': 'الاشتراك المميز فعّال حتى',
      'premium_days_3': '3 أيام اشتراك مميز',
      'premium_days_7': 'أسبوع اشتراك مميز',
      'premium_days_30': 'شهر اشتراك مميز',
      'coins_short': 'عملة',
      'subscribe_now': 'اشترك الآن',
      'other_payment_methods': 'طرق دفع أخرى',
      'whatsapp_payment': 'واتساب / تحويل بنكي (التفعيل خلال ~24 ساعة)',
      'premium_title': 'الاشتراك المميز',
      'monthly_plan': 'شهري — 6\$',
      'annual_plan': 'سنوي — 60\$ (شهران مجاناً)',
      'play_billing_unavailable':
          'الدفع عبر Google Play غير متاح في هذه النسخة بعد.',
      'ai_tutor': 'المدرس الذكي',
      'talk_with_tutor': 'تحدث مع المدرس الذكي',
      'tutor_intro':
          'أجرِ محادثة صوتية قصيرة حول هذا الدرس. حاول استخدام الكلمات المستهدفة!',
      'tutor_tap_to_speak': 'اضغط للتحدث',
      'tutor_listening': 'أستمع إليك…',
      'tutor_thinking': 'أفكر…',
      ...
      'choose_level_manually': 'اختر مستوى يدوياً',
      'coins_plus': 'عملة',
      'completion_bonus': 'مكافأة الإكمال',
      ...
      'streak_reminder': 'تذكير المواظبة اليومي',
      'preferred_time': 'وقت التذكير',
      'content_alert': 'تنبيهات المحتوى الجديد',
      'weak_area_alert': 'نصائح نقاط الضعف',
      'achievement_alert': 'فتح الإنجازات',
      'share_achievement': 'شارك إنجازك',
      'share_lesson_text':
          'أنهيت درس "{lesson}" في تطبيق Focus Languages واجتزت الاختبار بنسبة {percent}% 🎉',
      'words_learned': 'كلمات',
      'study_time': 'وقت الدراسة',
      'time_investment': 'الوقت المستثمر',
      'last_30_days': 'آخر 30 يوماً',
      'weak_areas': 'نقاط الضعف',
      'accuracy': 'دقة',
      'practice_now': 'تدرّب الآن',
      'level_progress': 'تقدّم المستويات',
      'skills_tree': 'المهارات',
      'vocab_heatmap': 'المفردات حسب الموضوع',
      'no_data_yet': 'ابدأ التعلّم لترى إحصائياتك هنا!',
